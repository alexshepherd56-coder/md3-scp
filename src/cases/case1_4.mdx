...
| Disease | Elevated lipid results |
|---|---|
| Predominant hypercholesterolaemia(mostly polygenic) | TC ± TG |
| Familial hypercholesterolaemia (LDL receptor defect, defective Apo B100, defective NARC-1 protease) | TC ± TG |
| Hyperalphalipoproteinaemia | TC |
| Predominant hypertriglycerideaemia (mostly polygenic) | TG |
| Lipoprotein lipase deficiency | TG > TC |
| Familial hypertriglycerideaemia | TG + TC |
| Mixed hyperlipidaemia (mostly polygenic) | TC + TG |
| Familial combined hyperlipidaemia* | TC and/or TG |
| Dysbetalipoproteinaemia* | TC and/or TG |
