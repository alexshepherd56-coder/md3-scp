...
# Case 17.5 – Adrenal Insufficiency

**Category:** {frontmatter.category} | **Discipline:** {frontmatter.discipline} | **Setting:** {frontmatter.setting}

## Case

John Mosby, 25 years old, has a long history of chronic asthma, which has required long term use of inhaled and oral corticosteroids to manage.</p>
    <p>He has been unwell over the last few days with vomiting and diarrhoea and presents with lethargy and looks pale and unwell.
