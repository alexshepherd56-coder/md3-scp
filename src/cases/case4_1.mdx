...
| Investigation Value | Gestation |
|---|---|
| Combined first trimesterMat age+NT+betaHCG+Papp-A | 11-13+6 weeks |
| Quadruple Test (late booking)Mat age+AFP+betaHCG+UE3+inhibin | 15-20 weeks |
| Cell-free DNA screening (NIPT) | >10 weeks |
