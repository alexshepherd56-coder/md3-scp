...
# Case 4.7 – Contraception (Adolescence)
...
**Contraceptive Options for Teenagers:**
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>**Combined Oral Contraceptive Pill (OCP)**</td>
              <td>Hormonal control - prevents ovulation in majority of women, changes cervical mucous, develops hostile endometrium for implantation</td>
              <td>0.1</td>
              <td>
            ...
            <tr>
              <td>**Sub-dermal Progesterone Implant**</td>
              <td>Progesterone effects - hostile endometrium and cervical mucous</td>
              <td>0.1</td>
              <td>
            ...
            <tr>
              <td>**Depo-Provera**</td>
              <td>Progesterone effects - hostile endometrium and cervical mucous, may stop ovulation</td>
              <td>0.3</td>
              <td>
