...
# Case 8.5 – Internal & External Haemorrhoids
...
**Distinguishing Features of Haemorrhoids:**
        ...
        <table>
          <tr>
            <th>Feature</th>
            <th>Internal Haemorrhoids</th>
            <th>External Haemorrhoids</th>
          </tr>
          <tr>
            <td>Location</td>
            <td>Above dentate line</td>
            <td>Below dentate line</td>
          </tr>
          <tr>
            <td>Pain</td>
            <td>Usually painless</td>
            <td>Painful when thrombosed</td>
          </tr>
          <tr>
            <td>Mucosa</td>
            <td>Rectal mucosa (insensate)</td>
            <td>Anoderm (richly innervated)</td>
          </tr>
          <tr>
            <td>Position</td>
            <td>Left lateral, right anterior, right posterior</td>
            <td>Variable</td>
          </tr>
        </table>
...
**Classification and Management of Internal Haemorrhoids:**
        ...
        <table>
          ...
          <tr>
            <td>**First**</td>
            <td>Bulge in the anal canal lumen; does not protrude outside the lumen</td>
            <td>
              **Asymptomatic:**
          ...
          <tr>
            <td>**Second**</td>
            <td>Protrudes with defaecation; reduces spontaneously</td>
            <td>
          ...
          <tr>
            <td>**Third**</td>
            <td>Protrudes with defaecation; must be reduced manually</td>
            <td>
          ...
          <tr>
            <td>**Fourth**</td>
            <td>Protrudes permanently; incarcerated</td>
            <td>
