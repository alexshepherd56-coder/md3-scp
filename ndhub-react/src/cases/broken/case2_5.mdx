...
# Case 2.5 – Acute Myocardial Infarction
...
<CaseQuestion
  number={2}
  question="What emergency management would you commence?"
>
...
<CaseQuestion
  number={3}
  question="Maud has classic ECG changes of an inferior acute myocardial infarction. Describe what these changes would be?"
>
...
<CaseQuestion
  number={4}
  question="What cardiac enzymes would you order and why?"
>
...
<CaseQuestion
  number={5}
  question="Maud suddenly develops acute cardiopulmonary arrest in the emergency department. Describe your immediate series of responses?"
>
