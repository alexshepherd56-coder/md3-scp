---
id: "8.7"
title: "Anal Fissures, Cancers and STIs [SDL]"
category: "Surgery"
...
# Case 8.7 – Anal Fissures, Cancers and STIs [SDL]
...
<CaseQuestion
  number={2}
  question="On examination you identify a tender anal fissure. How do anal fissures typically present?"
>
...
<CaseQuestion
  number={3}
  question="How are anal fissures treated?"
>
...
Treatment is based on the duration and severity of the symptoms.
        ...
        <h3>Conservative Management (Acute Fissures)</h3>
...
<CaseQuestion
  number={4}
  question="How do anal cancers present in terms of history and examination?"
>

**Anal Cancer Presentation:**

        <h3>Epidemiology and Types</h3>
        ...
        <h3>Malignant Melanoma Specific Features</h3>
...
<CaseQuestion
  number={5}
  question="What are the principles of treatment of an anal carcinoma?"
>

**Treatment Principles for Anal Carcinoma:**

        <h3>Historical Treatment</h3>
        ...
        <h3>Current Treatment for Epidermoid Anal Cancer</h3>
        ...
        <h3>Role of Surgery in Epidermoid Cancer</h3>
        ...
        <h3>Malignant Melanoma Treatment</h3>
