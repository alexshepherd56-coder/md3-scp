...
# Case 3.6 – Cholecystitis & Biliary Colic

**Category:** {frontmatter.category} | **Discipline:** {frontmatter.discipline} | **Setting:** {frontmatter.setting}

## Case

<strong>Patient:</strong> Annette Everley, 42 years old</p>
    <p><strong>Presentation:</strong> Acute right upper abdominal pain, screaming for pain relief</p>
    <p><strong>Vital Signs:</strong> Temperature 37.2°C</p>
    <p><strong>Physical Examination:</strong> Marked right upper quadrant (RUQ) tenderness
...
**7. Plain Abdominal X-ray**
        ...
        <h3>Recommended Imaging Algorithm</h3>
        

          - **First-line:** RUQ Ultrasound - for suspected biliary pathology

          - **If ultrasound positive for cholecystitis:** Proceed to surgical consultation

          - **If ultrasound equivocal:** Consider HIDA scan

          - **If concern for CBD stones:** Check CBD diameter on ultrasound
          ...
          - **If unclear diagnosis or concern for complications:** CT abdomen/pelvis
