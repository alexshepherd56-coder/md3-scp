...
<CaseQuestion
  number={1}
  question="Outline the types of angina and how they are differentiated?"
>
...
<CaseQuestion
  number={2}
  question="In dot format summarise the pathogenesis of ischaemic heart disease"
>
...
- Ischaemia heart disease (AKA coronary artery disease) occurs as the result of numerous risk factors. The major factors are smoking, diabetes, hypercholesterolemia, hypertension and a family history of premature coronary artery disease (female &lt;65, male&lt;55)
          ...
          - The clinical presentations follow development of atheromatous plaques:
            <ol style="list-style-type: upper-roman;">
              - Activated endothelial cells express adhesion molecules and recruit inflammatory cells, especially monocytes

              - Monocytes migrate into the intima of the artery wall and differentiate into macrophages and ingest lipid into foam cells

              - Cytokines and growth factors produced by the activated macrophages induce smooth muscle cell migration into the intima; the migrating smooth muscle cells change from their contractile properties to properties that allow them to repair the damaged intima

              - If the cells are successful, the lipid core is covered by cells to form a stable plaque of atherosclerosis

              - If the cells are not successful, inflammation predominates and the plaque becomes unstable and the fiberous cap thins

              - The plaque becomes susceptible to mechanical stress and the irregular surface becomes a focus for platelet aggregation and thrombus formation

              - The formation of thrombous leads to partial or complete obstruction of the artery lumen.
...
<CaseQuestion
  number={4}
  question="What features would suggest the pain was cardiac in nature?"
>
...
<CaseQuestion
  number={5}
  question="Using a table list the following drugs and their mechanism of action - nitrates, beta blockers, thrombolytics, antiplatelet agents?"
>
...
<table>
          ...
          <tr>
            <td>nitrates</td>
            <td>Vascular smooth muscle relaxation to produce venous and arteriolar dilatation leading to reduced preload and increase myocardial O2 supply</td>
          </tr>
          <tr>
            <td>β-blockers</td>
            <td>Reduce heart rate, blood pressure and myocardial contractility therefore lowering myocardial demand for O2</td>
          </tr>
          <tr>
            <td>thrombolytics</td>
            <td>Dissolve blood clots by activating plasminogen thereby restoring coronary patency</td>
          </tr>
          <tr>
            <td>anti-platelet agents<br>• aspirin<br>• IIb/IIIa platelet receptor inhibitors</td>
            <td>Inhibit platelet aggregation</td>
          </tr>
        </table>
...
<CaseQuestion
  number={6}
  question="What further investigations would you order?"
>
