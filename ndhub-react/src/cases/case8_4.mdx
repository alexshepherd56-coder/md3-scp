...
<CaseQuestion
  number={2}
  question="An abdominal series X-ray demonstrate massive colonic distension. What are the likely causes for the obstruction?"
>
...
<CaseQuestion
  number={3}
  question="How does colonic obstruction typically present?"
>
...
<CaseQuestion
  number={4}
  question="Outline the management of colonic obstruction."
>
...
Management depends on whether the obstruction is partial (some lumen persists on CT) or complete.
        ...
        <h3>Partial Obstruction - Conservative Management May Include:</h3>
        ...
        <h3>Emergency Surgery Indications:</h3>
...
**Emergency laparotomy is undertaken for acute large bowel obstruction with:**
        ...
        <h3>Important Consideration - Ileocaecal Valve:</h3>
...
<CaseQuestion
  number={5}
  question="What is volvulus of the large intestine & what risk factors have been identified for this condition?"
>
...
<CaseQuestion
  number={6}
  question="How does volvulus present clinically?"
>
...
<CaseQuestion
  number={7}
  question="What are the X-ray features of colonic obstruction?"
>

**Plain Film (Abdominal X-ray) Findings:**

        <h3>General Features of Colonic Obstruction:</h3>
        ...
        <h3>Specific Findings in Sigmoid Volvulus:</h3>
        ...
        <h3>Specific Findings in Caecal Volvulus:</h3>
